        ...
        <div className='max-w-[1400px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6'>
            ...
            <div className="rounded-xl relative">
                ...
                <div className="absolute w-full h-full bg-black/50 rounded-xl text-white">
                    ...
                    <p className="px-2">Through 11/26</p>
                    <button className="border-white bg-white text-black mx-2 absolute bottom-4 transform duration-500 hover:-translate-y-2">Order Now</button>
                </div>
                <img
